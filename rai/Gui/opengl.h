...
//  uint fbo, render_buf;
  ...
  OpenGL(const char* title="rai::OpenGL", int w=800, int h=800, bool _offscreen=false, bool _fullscreen=false, bool _hideCameraControls=false, bool _noCursor=false);
