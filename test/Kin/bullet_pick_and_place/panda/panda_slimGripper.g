...
#Edit panda_hand_1{ color:[ 0.2, 0.2, 0.2 0.5]}

Include 'slimGripper.g'
Edit hand (panda_hand_joint) { Q:<d(90 0 0 1)>}

#panda_gripper (gripper) { shape:mesh  mesh:'../dataset/franka_gripper_collision_mesh.stl' color:[.9 .4 .4 .5],}
